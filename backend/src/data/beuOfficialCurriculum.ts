...
// ------------------------------------------------------------------------------------------------
// 2. REGULATIONS & ACADEMIC SESSIONS
// ------------------------------------------------------------------------------------------------
    ...
    units: [
      {
        id: 'unit-phy-u1',
        unitNumber: 1,
        unitTitle: 'Unit 1: Wave Optics (Interference & Diffraction)',
        hours: 9,
        examFrequency: 'HIGH',
        sourceUrl: 'https://beu-bih.ac.in/academics/Syllabus/B.Tech',
        description: 'Huygens’ principle, interference of light by division of wavefront and amplitude; Young’s double slit, Newton’s rings; Fraunhofer diffraction at single and double slit, grating.',
        topics: [
          {
            id: 'topic-phy-u1-t1',
            orderIndex: 1,
            title: 'Thin Film Interference & Newton’s Rings',
            hours: 4.5,
            isCore: true,
            learningOutcomes: ['Calculate wavelength of monochromatic light using Newton’s rings apparatus'],
            subTopics: [
              { id: 'sub-p1-1', orderIndex: 1, title: 'Wedge Shaped Thin Films Interference' },
              { id: 'sub-p1-2', orderIndex: 2, title: 'Newton’s Rings Diameter Formulation for Bright & Dark Rings' },
            ],
          },
          {
            id: 'topic-phy-u1-t2',
            orderIndex: 2,
            title: 'Fraunhofer Diffraction & Plane Transmission Grating',
            hours: 4.5,
            isCore: true,
            learningOutcomes: ['Compute resolving power and dispersive power of diffraction gratings'],
            subTopics: [
              { id: 'sub-p1-3', orderIndex: 1, title: 'Single Slit & N-Slit Diffraction Patterns' },
              { id: 'sub-p1-4', orderIndex: 2, title: 'Rayleigh Criterion of Resolving Power' },
            ],
          },
        ],
      },
      {
        id: 'unit-phy-u2',
        unitNumber: 2,
        unitTitle: 'Unit 2: Lasers & Optical Fiber Communication',
        hours: 9,
        examFrequency: 'HIGH',
        sourceUrl: 'https://beu-bih.ac.in/academics/Syllabus/B.Tech',
        description: 'Einstein’s A and B coefficients, population inversion, Ruby laser, He-Ne laser; Optical fiber principle, numerical aperture, step-index and graded-index fibers, attenuation in fibers.',
        topics: [
          {
            id: 'topic-phy-u2-t1',
            orderIndex: 1,
            title: 'Laser Principles & He-Ne / Ruby Laser Systems',
            hours: 4.5,
            isCore: true,
            learningOutcomes: ['Explain 3-level and 4-level laser operations and optical pumping'],
            subTopics: [
              { id: 'sub-p2-1', orderIndex: 1, title: 'Stimulated Emission & Einstein Coefficients' },
              { id: 'sub-p2-2', orderIndex: 2, title: 'He-Ne Gas Laser Construction and Transition Scheme' },
            ],
          },
          {
            id: 'topic-phy-u2-t2',
            orderIndex: 2,
            title: 'Optical Fiber Types, Numerical Aperture & Losses',
            hours: 4.5,
            isCore: true,
            learningOutcomes: ['Calculate acceptance angle, numerical aperture and V-number of optical waveguides'],
            subTopics: [
              { id: 'sub-p2-3', orderIndex: 1, title: 'Total Internal Reflection & Acceptance Cone' },
              { id: 'sub-p2-4', orderIndex: 2, title: 'Step-Index vs Graded-Index Optical Fibers' },
            ],
          },
        ],
      },
      {
        id: 'unit-phy-u3',
        unitNumber: 3,
        unitTitle: 'Unit 3: Quantum Mechanics Foundations',
        hours: 9,
        examFrequency: 'HIGH',
        sourceUrl: 'https://beu-bih.ac.in/academics/Syllabus/B.Tech',
        description: 'De-Broglie hypothesis, Compton effect, Heisenberg uncertainty principle, wave function physical significance; Time-dependent and time-independent Schrödinger wave equations; Particle in 1D box.',
        topics: [
          {
            id: 'topic-phy-u3-t1',
            orderIndex: 1,
            title: 'Matter Waves & Schrödinger Equation',
            hours: 5.0,
            isCore: true,
            learningOutcomes: ['Derive time-independent Schrödinger equation and normalize wavefunctions'],
            subTopics: [
              { id: 'sub-p3-1', orderIndex: 1, title: 'De Broglie Hypothesis & Davisson-Germer Experiment' },
              { id: 'sub-p3-2', orderIndex: 2, title: 'Schrödinger Wave Equation in 1-Dimension' },
            ],
          },
          {
            id: 'topic-phy-u3-t2',
            ...
            hours: 4.0,
            isCore: true,
            learningOutcomes: ['Calculate energy eigenvalues and eigenfunctions for a bounded quantum particle'],
            subTopics: [
              { id: 'sub-p3-3', orderIndex: 1, title: 'Quantized Energy Levels and Zero-Point Energy' },
              { id: 'sub-p3-4', orderIndex: 2, title: 'Wave Function Probability Density Distributions' },
            ],
          },
        ],
      },
      {
        id: 'unit-phy-u4',
        unitNumber: 4,
        unitTitle: 'Unit 4: Semiconductor Physics & Band Theory',
        hours: 9,
        examFrequency: 'HIGH',
        sourceUrl: 'https://beu-bih.ac.in/academics/Syllabus/B.Tech',
        description: 'Kronig-Penney model (qualitative), E-k diagram, effective mass; Intrinsic and extrinsic semiconductors, Fermi level, carrier concentration; Hall effect and its applications.',
        topics: [
          {
            id: 'topic-phy-u4-t1',
            orderIndex: 1,
            title: 'Band Theory of Solids & Fermi-Dirac Distribution',
            hours: 4.5,
            isCore: true,
            learningOutcomes: ['Differentiate metals, semiconductors and insulators based on Fermi energy level'],
            subTopics: [
              { id: 'sub-p4-1', orderIndex: 1, title: 'Kronig-Penney Model & Energy Band Splitting' },
              { id: 'sub-p4-2', orderIndex: 2, title: 'Fermi Level Position in Intrinsic and N/P Semiconductors' },
            ],
          },
          {
            id: 'topic-phy-u4-t2',
            orderIndex: 2,
            title: 'Carrier Transport & Hall Effect',
            hours: 4.5,
            isCore: true,
            learningOutcomes: ['Measure Hall coefficient, charge carrier density and semiconductor mobility'],
            subTopics: [
              { id: 'sub-p4-3', orderIndex: 1, title: 'Drift and Diffusion Currents in Semiconductors' },
              { id: 'sub-p4-4', orderIndex: 2, title: 'Hall Effect Derivation and Practical Applications' },
            ],
          },
        ],
      },
      {
        id: 'unit-phy-u5',
        unitNumber: 5,
        unitTitle: 'Unit 5: Electromagnetism & Dielectric Materials',
        hours: 9,
        examFrequency: 'HIGH',
        sourceUrl: 'https://beu-bih.ac.in/academics/Syllabus/B.Tech',
        description: 'Maxwell’s equations in differential and integral forms, electromagnetic wave propagation in vacuum; Dielectric polarization, Clausius-Mossotti equation, magnetic properties of materials.',
        topics: [
          {
            id: 'topic-phy-u5-t1',
            orderIndex: 1,
            ...
            hours: 5.0,
            isCore: true,
            learningOutcomes: ['Derive wave equation for E and B fields in dielectric media and free space'],
            subTopics: [
              { id: 'sub-p5-1', orderIndex: 1, title: 'Displacement Current & Maxwell’s 4 Equations' },
              { id: 'sub-p5-2', orderIndex: 2, title: 'Poynting Vector and Energy Flow Density' },
            ],
          },
          {
            id: 'topic-phy-u5-t2',
            orderIndex: 2,
            title: 'Dielectric Polarization & Magnetic Materials',
            hours: 4.0,
            isCore: true,
            learningOutcomes: ['Classify dia, para, ferro magnetic substances and compute dielectric constant'],
            subTopics: [
              { id: 'sub-p5-3', orderIndex: 1, title: 'Electronic, Ionic and Orientational Polarization' },
              { id: 'sub-p5-4', orderIndex: 2, title: 'Clausius-Mossotti Relation & Hysteresis B-H Curve' },
            ],
          },
        ],
      },
